...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $property_id = DB::table('properties')->insertGetId([
            'user_id' => $user_id,
            'property_name' => 'Freetobook Hotel',
        ...
        DB::table('home_pages')->insert([
            'property_id' => $property_id,
            'meta_page_title' => 'Welcome to freetobook',
            ...
            'cover_image_primary' => '',
            'intro_section_header' => 'Introducing freetobook...',
            ...
            'welcome_section_header' => 'Welcome to freetobook hotel',
        ...
        DB::table('rooms_pages')->insert([
            'property_id' => $property_id,
            'meta_page_title' => 'Rooms at freetobook',
        ...
        DB::table('reviews_pages')->insert([
            'property_id' => $property_id,
            'meta_page_title' => 'Reviews of freetobook',
        ...
        DB::table('about_pages')->insert([
            'property_id' => $property_id,
            'meta_page_title' => 'All about freetobook',
        ...
        DB::table('explore_pages')->insert([
            'property_id' => $property_id,
            'meta_page_title' => 'Things to do near freetobook',
        ...
        DB::table('find_us_pages')->insert([
            'property_id' => $property_id,
            'meta_page_title' => 'Come and find freetobook hotel',
        ...
        DB::table('faq_pages')->insert([
            'property_id' => $property_id,
            'meta_page_title' => 'Your questions about freetobook',
        ...
        DB::table('questions_and_answers')->insert([
            [
                ...
                'answer_paragraph' => 'Making a reservation is easy! Simply visit our website and use the user-friendly booking interface. Alternatively, you can call our reservation team at [phone number] for personalized assistance.',
            ],
            [
                'property_id' => $property_id,
                'question_label' => 'What amenities are included in the room rate?',
                'answer_paragraph' => 'Your room rate covers a range of amenities, including complimentary Wi-Fi, access to our fitness center, and daily housekeeping. Additionally, we offer [specific amenities] to ensure your stay is as comfortable and enjoyable as possible.',
            ],
        ]);
    }
}
