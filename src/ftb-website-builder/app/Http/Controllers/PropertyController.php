...
class PropertyController
{
    ...
    public function update(Request $request): RedirectResponse
    {
        $request->validate([
            ...
            'property_address_line_2' => ['required', 'string', 'max:255'],
            ...
            'property_twitter_link' => ['required', 'string', 'max:255'],
            'property_youtube_link' => ['required', 'string', 'max:255'],
            'property_linkedin_link' => ['required', 'string', 'max:255'],
            'property_facebook_link' => ['required', 'string', 'max:255'],
            'property_instagram_link' => ['required', 'string', 'max:255'],
